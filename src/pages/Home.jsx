    ...
    <>
      ...
      <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center max-w-4xl px-gutter">
          ...
          <h1 className="font-display-lg text-4xl sm:text-5xl md:text-display-lg text-on-background mb-6 leading-tight">
            Stories of Love.<br />Captured Forever.
          </h1>
          <p className="font-body-lg text-base sm:text-body-lg text-on-surface-variant mb-12 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link
              to="/portfolio"
              className="gold-border px-10 py-4 font-label-md text-label-md uppercase tracking-widest transition-all duration-300 hover:bg-primary hover:text-background w-full sm:w-auto min-w-[220px] text-center"
            >
              View Portfolio
            </Link>
            <Link
              to="/inquire"
              className="px-10 py-4 font-label-md text-label-md uppercase tracking-widest transition-all duration-300 text-on-background border border-transparent hover:border-primary/50 w-full sm:w-auto min-w-[220px] text-center"
            >
              Book Consultation
            </Link>
          </div>
      ...
      <section className="py-section-gap overflow-hidden">
        <div className="max-w-container-max mx-auto px-gutter mb-16 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6">
          <div>
        ...
        <div className="flex space-x-6 sm:space-x-8 overflow-x-auto scrollbar-hide px-gutter pb-8 snap-x snap-mandatory cursor-grab active:cursor-grabbing">
          {/* Story Card 1 */}
          <div className="min-w-[85vw] sm:min-w-[500px] md:min-w-[600px] snap-center group">
            <div className="relative aspect-[4/5] overflow-hidden mb-6 border border-surface-container-highest">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-6 sm:p-10">
                <span className="font-label-md text-label-md uppercase tracking-widest text-primary mb-2">
                  Location
                </span>
                <p className="font-headline-md text-xl sm:text-headline-md text-on-background">
            ...
            <div className="flex justify-between items-start">
              <div>
                <h3 className="font-headline-md text-xl sm:text-headline-md text-on-background mb-2">
                  A Royal Lake Affair
                </h3>
      ...
      <section className="py-section-gap bg-surface-container-lowest overflow-hidden">
        <div className="max-w-container-max mx-auto flex flex-col lg:flex-row items-stretch min-h-[500px] lg:min-h-[700px]">
          <div className="w-full lg:w-1/2 min-h-[350px] lg:min-h-0 relative">
            <img
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center px-gutter sm:px-12 lg:px-24 py-16 sm:py-20 bg-background">
            <span className="font-label-md text-label-md uppercase tracking-widest text-primary mb-6 block">
              Our Philosophy
            </span>
            <h2 className="font-headline-lg text-3xl sm:text-4xl lg:text-headline-lg text-on-background mb-8 leading-snug">
            ...
            <div className="mt-12 flex items-center space-x-6">
              <div className="h-px w-16 sm:w-20 bg-primary"></div>
              <span className="font-headline-md text-lg sm:text-headline-md text-primary italic">
      ...
      <section className="py-section-gap px-gutter">
        <div className="max-w-container-max mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Udaipur */}
            <div className="relative group h-[400px] sm:h-[500px] overflow-hidden border border-primary/20">
              <img
                alt="Udaipur"
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                <h3 className="font-display-lg text-2xl sm:text-headline-md text-on-background mb-2 tracking-widest uppercase">
                  Udaipur
                </h3>
                <div className="h-px w-12 bg-primary mb-4 transition-all duration-500 group-hover:w-32"></div>
                <p className="font-label-md text-xs sm:text-label-md uppercase tracking-widest text-on-surface group-hover:text-primary transition-colors">
                  The City of Lakes
                </p>
              </div>
            </div>
      ...
      <section className="py-section-gap bg-surface-container-lowest px-gutter">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="font-quote text-lg sm:text-xl md:text-quote text-on-background italic mb-8 leading-relaxed">
